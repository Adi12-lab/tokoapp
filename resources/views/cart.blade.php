      ...
      <div class="card rounded-0">
        <div class="row cart-row">
            ...
            <div class="row g-2 justify-content-center">
              ...
              <div class="cart dropdown size">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" data-dropdown="{{$size->name}}"><i class="bi bi-check-lg {{$cart->attributes->size == $size->name ? "": "invisible"}}"></i> {{$size->name}}</a></li>
                  @endforeach
                </ul>
              </div>
                @endisset
          ...
          <div class="col-md-2 d-flex cart-col">
            ...
            <input type="number" class="form-control quantity-form rounded-0" value="{{$cart->quantity}}">
