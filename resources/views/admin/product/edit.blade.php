              ...
              <div class="col col-md-8">
                      <form action="/metal/products/{{$product->slug}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="origin">
                                ...
                                @foreach ($origin as $org)
                                    <option value="{{ $org->id_city }}" @if ($product->origin == $org->id_city) selected @endif>{{ $org->nama }}</option>
                                @endforeach
                            </select>
                            @error('origin')
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <img class="image_preview d-block mb-3" src="{{asset("storage/".$product->gambar)}}" style="width:500px;">
                        ...
                        <div class="table-responsive my-2">
                          ...
                          <ul>
                            <li>
                                Tiap produk pasti memiliki berat dan harga, akan tetapi ada juga produk yang memiliki size, harga, dan berat, jadi jika produk anda tidak membutuhkakn <strong>jenis size</strong> maka anda dapat kosongkan  <strong> kolom size </strong>,akan tetapi anda wajib mengisi kolom yang lain. <strong>Mohon untuk tidak menambahkan baris baru</strong>
                            </li>
                            <li>
                                ...
                                <tbody class="body_table size">
                                    @foreach($product->size as $size)
                                        <tr>
                                            ...
                                            <td><input class="form-control size_form" value="{{ old("size_name", $size->name)}}" type="text" name="size_name[]"></td>
                                            <td><input class="form-control size_form" value="{{ old("size_weignt", $size->weight)}}" type="number" name="size_weight[]"></td>
                                            <td><input class="form-control size_form" value="{{ old("size_price", $size->price)}}" type="number" name="size_price[]"></td>
                                            <td><input class="form-control size_form" value="{{ old("size_name", $size->old_price)}}" type="number" name="old_price[]"></td> 
                              ...
                              <thead>
                                  ...
                                  <tbody class="body_table variant">
                                    ...
                                    <tr>
                                      ...
                                      <td><input class="form-control" value="{{ old("variant", $variant->name)}}" type="text" name="variant_name[]"></td>
                                      <td><button type="button" class="btn-close ms-3 mt-1"></button></td>
                                    </tr> 
                                    @endforeach
                                  </tbody>
