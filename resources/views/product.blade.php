                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <a class="product-title d-block text-decoration-none"
                                                href="/product/{{ $product->slug }}">{{ $product->nama }}</a>
                                            <p class="product-text">{{ $product->deskripsi }}</p>
                                            <span class="product-price fs-2" data-price="{{ $product->harga }}">Rp.
                                                {{ $product->harga }}</span>
                                            ...
                                            <div class="product-bottom mt-2">
                                                <form action="{{ route('productIndex.addCart') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="productName" value="{{ $product->nama }}">
                                                    <input type="hidden" name="productPrice" value="{{ $product->harga }}">
